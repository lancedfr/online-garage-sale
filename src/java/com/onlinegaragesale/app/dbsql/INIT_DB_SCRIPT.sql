...
CREATE UNIQUE INDEX PRODUCTSALES_PK ON PRODUCTSALES
  ...
  CREATE TABLE ROLES
    ...
    TABLESPACE USERS LOGGING ;
  ALTER TABLE ROLES ADD CONSTRAINT ROLES_PK PRIMARY KEY
  (
    ROLEID
  )
...
CREATE UNIQUE INDEX USERACCOUNT_PK ON USERACCOUNT
  ...
  NOT DEFERRABLE ;
  ALTER TABLE ROLES ADD CONSTRAINT ROLE_USERACCOUNT_FK FOREIGN KEY
  (
    USERID
  )
  REFERENCES USERACCOUNT
...
CREATE SEQUENCE ROLES_ID_SEQ INCREMENT BY 1 MAXVALUE 9999999999999999999999999999 MINVALUE 1 CACHE 20 ;
CREATE SEQUENCE SALESHISTORY_ID_SEQ INCREMENT BY 1 MAXVALUE 9999999999999999999999999999 MINVALUE 1 CACHE 20 ;
CREATE SEQUENCE USERACCOUNT_ID_SEQ INCREMENT BY 1 START WITH 4004 MAXVALUE 99999999 MINVALUE 1 CACHE 20 
;