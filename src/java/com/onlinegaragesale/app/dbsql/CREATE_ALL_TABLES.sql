...
CREATE INDEX SALESHISTORY__IDXv1 ON SALESHISTORY 
    ( 
     SALESID ASC 
    ) 
    TABLESPACE USERS 
...
ALTER TABLE SALESHISTORY 
    ADD CONSTRAINT SALESHISTORY_PK PRIMARY KEY ( SALESID ) ;
