...
CREATE OR REPLACE TRIGGER BID_ID_TRG 
    ...
    FOR EACH ROW 
BEGIN <<COLUMN_SEQUENCES>> BEGIN   SELECT BID_ID_SEQ.NEXTVAL INTO :NEW.BIDID FROM DUAL; END COLUMN_SEQUENCES; END;   
/
...
CREATE OR REPLACE TRIGGER CATEGORY_ID_TRG 
    ...
    FOR EACH ROW 
BEGIN <<COLUMN_SEQUENCES>> BEGIN   SELECT CATEGORY_ID_SEQ.NEXTVAL INTO :NEW.CATEGORYID FROM DUAL; END COLUMN_SEQUENCES; END;   
/
...
CREATE OR REPLACE TRIGGER GARAGE_ID_TRG 
    ...
    FOR EACH ROW 
BEGIN <<COLUMN_SEQUENCES>> BEGIN   SELECT GARAGE_ID_SEQ.NEXTVAL INTO :NEW.GARAGEID FROM DUAL; END COLUMN_SEQUENCES; END;   
/
...
CREATE OR REPLACE TRIGGER PRODUCTSALES_ID_TRG 
    ...
    FOR EACH ROW 
BEGIN <<COLUMN_SEQUENCES>> BEGIN   SELECT PRODUCTSALES_ID_SEQ.NEXTVAL INTO :NEW.PRODID FROM DUAL; END COLUMN_SEQUENCES; END;   
/
...
CREATE OR REPLACE TRIGGER PRODUCT_ID_TRG 
    ...
    FOR EACH ROW 
BEGIN <<COLUMN_SEQUENCES>> BEGIN   SELECT PRODUCT_ID_SEQ.NEXTVAL INTO :NEW.PRODID FROM DUAL; END COLUMN_SEQUENCES; END;   
/
...
CREATE OR REPLACE TRIGGER SALESHISTORY_ID_TRG 
    ...
    FOR EACH ROW 
BEGIN <<COLUMN_SEQUENCES>> BEGIN   SELECT SALESHISTORY_ID_SEQ.NEXTVAL INTO :NEW.USERID FROM DUAL; END COLUMN_SEQUENCES; END;   
/
...
CREATE OR REPLACE TRIGGER USERACCOUNT_ID_TRIG 
    ...
    FOR EACH ROW 
BEGIN :NEW.USERID := CREATE_USERACCOUNT_ID; END;   
/
