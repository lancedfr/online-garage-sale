<%-- 
    Document   : signup
    Created on : 16 Oct 2012, 6:20:01 PM
    Author     : Lance
--%>
    ...
    <body>
        ...
        <div class="container">
            <div>
                ...
                <f:form action="signupprocess.html" method="post" novalidate="" modelAttribute="useraccountBean">
                    <div id="field6-container" class="field f_100">
                        <label for="field6">
                            First Name
                        </label>
                        <f:input type="text" path="firstname" id="field6" required="required"/>
                    </div>
                    <div id="field7-container" class="field f_100">
                        <label for="field7">
                            Middle Name
                        </label>
                        <f:input type="text" path="middlename" id="field7"/>
                    </div>
                    <div id="field8-container" class="field f_100">
                        <label for="field8">
                            Last Name
                        </label>
                        <f:input type="text" path="lastname" id="field8" required="required"/>
                    </div>
                    ...
                    <div id="field10-container" class="field f_100">
                        ...
                        <f:input type="email" path="email" id="field10" required="required"/>
                    </div>
                    <div id="field15-container" class="field f_100">
                        <label for="field15">
                            Home Telephone
                        </label>
                        <f:input type="text" path="hometell" id="field15" pattern="[0-9]{10}"/>
                    </div>
                    <div id="field16-container" class="field f_100">
                        <label for="field16">
                            Work Telephone
                        </label>
                        <f:input type="text" path="worktell" id="field16" pattern="[0-9]{10}"/>
                    </div>
                    <div id="field17-container" class="field f_100">
                        <label for="field17">
                            Cell Number
                        </label>
                        <f:input type="text" path="cell" id="field17" pattern="[0-9]{10}"/>
                    </div>
                    <div id="field18-container" class="field f_100">
                        <label for="field18">
                            Address
                        </label>
                        <f:textarea rows="5" cols="20" path="addressline" id="field18" required="required"></f:textarea>
                    </div>
                    <div id="field19-container" class="field f_100">
                        <label for="field19">
                            Area Code
                        </label>
                        <f:input type="text" path="areacode" id="field19" required="required" pattern="[0-9]{4}"/>
                    </div>
                    <div id="field23-container" class="field f_100">
                        <label for="field23">
                            City
                        </label>
                        <f:input type="text" path="city" id="field23" required="rquired"/>
                    </div>
                    <div id="field22-container" class="field f_100">
                        <label for="field22">
                            Country
                        </label>
                        <f:select path="country" id="field22" required="required">
                            <option></option>
                    ...
                    <div id="field20-container" class="field f_100">
                        ...
                        <f:input type="password" path="accountpassword" id="field20" required="required"/>
                    </div>
